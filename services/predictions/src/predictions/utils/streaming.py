"""Streaming utilities for Kafka/QuixStreams integration."""

from loguru import logger
from typing import Dict, Any
from quixstreams import Application

from predictions.config import Settings
...
def validate_indicators_optional(indicators: dict) -> None:
    ...
    Args:
        indicators: Dictionary containing technical indicators to validate
    """
    try:
        # Basic validation
...
def create_streaming_application(settings: Settings) -> Application:
    """
    Create and configure QuixStreams application for predictions processing.
    
    Args:
        settings: Application settings
        
    Returns:
        Configured QuixStreams Application
    """
...
def setup_streaming_dataflow(app: Application, settings: Settings):
    """
    Set up the streaming dataflow for processing indicators to predictions.
